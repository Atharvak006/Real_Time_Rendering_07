...
int main(void)
{
    ...
    printf("\n\n");
    printf("*** USING ARRAY NAME AS A ARRAY ie: Value of xth element of iArray: iArray[x] and address of xth element of iArray: &iArray[x]***\n\n");
    ...
    printf("\n\n");
    printf("***USING POINTER AS POINTER ie: VALUE of xth element of iArray: *(ptr_iArray + x) AND address of xth element of iArray: (ptr_iArray + x) ***\n\n");
