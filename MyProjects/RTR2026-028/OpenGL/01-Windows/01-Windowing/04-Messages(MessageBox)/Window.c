...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(iMsg)
    {
        ...
        case WM_SIZE:
            MessageBox(hwnd,TEXT("WM_SIZE is recieved."), TEXT("Message"),MB_OK);
            break;
        ...
        case WM_KEYDOWN:
            ...
            {
                case VK_ESCAPE:
                    MessageBox(hwnd,TEXT("Escape is pressed."), TEXT("Message"),MB_OK);
                    break;
        ...
        case WM_CHAR:
            switch(wParam)
            {
                case 'F':
                case 'f':
                    MessageBox(hwnd,TEXT("WM_CHAR is recieved."), TEXT("Message"),MB_OK);
        ...
        case WM_CLOSE:
            MessageBox(hwnd,TEXT("WM_CLOSE is recieved."), TEXT("Message"),MB_OK);
            break;
