...
void resize(int Width, int Height)
{
    ...
    // Here FOV(Field of view) is considered
    /*
        ie : FOVx and FOVy
        for x and y axis
        ...
        But this calculation is hard to implement
        therefore Graphic Library of Utilities(GLU) is used.
        and in GLU there is an function called gluPerspective() which is used. 
    */

    // Perspective Projection.

    /*
        opengl follow right hand rule for z axis positive and negative and it 
        counts vertices anti-clock wise
    */
...
void render(void)
{
    ...
    // In FFP if no is given , white color is assumed
